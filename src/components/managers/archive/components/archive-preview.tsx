...
export function ArchivePreview({
  ...
  return (
    // Same shape as hero's live preview: the chrome around the frame is a block, the frame
    // itself is a viewport onto the real storefront and keeps its own vocabulary.
    <Section
      title='live preview'
      action={
