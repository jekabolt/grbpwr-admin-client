 ...
 * живут дальше в контракте и в ЗАМОРОЖЕННОЙ ИСТОРИИ — их не трогать. Второй читатель (векторный
 * прогон, сужавший себя до своей плиты) снят с клиента в H-1, круг 14, и с тех пор все писатели
 * шлют оба поля пустыми; см. шапку `bench-slot.tsx`.
 */
...
export function Bench({
  ...
  /* ⚠ ХУКА РАЗРЕЗА ЗДЕСЬ БОЛЬШЕ НЕТ, И ЭТО ПРОДОЛЖЕНИЕ F-18, А НЕ УБОРКА. Обе двери, которые его
     ...
     с объявленными видами — дверь `split ▸` в полосе выходов (`render/outputs.tsx`) — и на
     референсах. */
