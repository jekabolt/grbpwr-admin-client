 ...
 * половина — «шов будет виден на настиле» и «посмотрите на 3×3 сами». Последнее сказано не из
 * вежливости: сервер ловит плитку, которая НЕ заворачивается, и рамку по краю, но не ловит ту,
 * которая заворачивается и всё равно заметно повторяется. Это судит глаз, и только глаз.
 */
export const SEAM_WORDS =
  ...
  'is show a seam every repeat when the cloth is laid out. Look at the 3×3 above before you keep it.';
