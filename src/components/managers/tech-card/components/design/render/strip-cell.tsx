...
/* ═══════════════════════════════════════════════════════════════════════════════════════════════
   ПУСТАЯ ЯЧЕЙКА НА ДВЕ ПОЛОВИНЫ (r2 п.28) ЖИВЁТ В `../core` — `core/two-half-slot.tsx`.
   ═══════════════════════════════════════════════════════════════════════════════════════════════

   Здесь стояла ЛОКАЛЬНАЯ КОПИЯ органа: волну r2 писали семь агентов, и тот же плейсхолдер в те же
   часы чертил агент зоны D в `references-section.tsx` / `bench-slot.tsx`. Копия сама назвала себя
   копией и просила свести после волны — сведено на гейте: одна коробка, одна линия посередине,
   одно перо (`PlaceOrDrawCell`, `DrawHalf`, `PenGlyph`). Расхождение кожи между двумя начертаниями
   и было причиной сводить: у копии половины несли ПО СВОЕЙ пунктирной рамке внахлёст на пиксель,
   у оригинала рамку несёт коробка, а половины делит одна линия — форма, которую владелец и описал
   словами («разделён горизонтальной линией пополам»). */
