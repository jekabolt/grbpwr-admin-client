 ...
 * на самой детали. Но поток, которым пользуются, — другой: назначение детали ткани на вкладке
 * колорвеев (кнопка «назначить детали» на карточке ткани; до перестройки — «+ добавить материал к
 * детали» на карточке детали) пишет СТРОКУ РЕЦЕПТА (tech_card_colorway_usage с piece_id), а не
 * материал детали, — и жест поменял направление, а запись осталась той же самой. На
