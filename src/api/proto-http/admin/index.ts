...
export type GetBusinessMetricsRequest = {
  periodFrom: wellKnownTimestamp | undefined;
  periodTo: wellKnownTimestamp | undefined;
  comparePeriodFrom: wellKnownTimestamp | undefined;
  comparePeriodTo: wellKnownTimestamp | undefined;
  ...
  return {
    ...
    GetBusinessMetrics(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      if (request.periodFrom) {
        queryParams.push(`periodFrom=${encodeURIComponent(request.periodFrom.toString())}`)
      }
      if (request.periodTo) {
        queryParams.push(`periodTo=${encodeURIComponent(request.periodTo.toString())}`)
      }
      if (request.comparePeriodFrom) {
        queryParams.push(`comparePeriodFrom=${encodeURIComponent(request.comparePeriodFrom.toString())}`)
      }
      if (request.comparePeriodTo) {
        queryParams.push(`comparePeriodTo=${encodeURIComponent(request.comparePeriodTo.toString())}`)
      }
