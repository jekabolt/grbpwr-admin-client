...
// ПАНЕЛЬ ИНСТРУМЕНТОВ — ТОЛЬКО ВИДЫ, восемь чипов в одну строку.
//
...
// восемью видами дали бы семнадцать контролов — это уже поиск, а не инструмент.
//
...
//
// ПАНЕЛЬ ОДНА НА ПОЛОСУ/ЛИСТ, а не на кадр: семь чипов под каждым из десяти снимков съели бы
...
export function AnnotationToolbar({
  tool,
  onTool,
  /** Виды, доступные на этой поверхности. Примерка, например, оставляет только пин. */
  kinds,
