...
// Clean GRBPWR monogram (outline) for document headers and compact brand marks.
// One stroked path drawn in `currentColor`, so it inherits the surrounding text color —
// crisp black on white in the tech pack / invoice, white on a dark surface. Source: the brand
// logo frame (600×600), path verbatim; the viewBox crops the frame to the stroke bounds
// (60..540 ± 18), so the mark fills its box edge to edge.
export function GrbpwrMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox='42 42 516 516'
      fill='none'
