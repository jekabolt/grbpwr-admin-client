...
console.log('\n10 · сводка: свёрнутая полоса несёт все исходы словами');
{
  ...
  ck(
    line === 'готово 3 из 8 · идёт 1 · превью 1 · в очереди 1 · 1 обрыв · 1 отказ · 1 дубликат · 1 не пролезет',
    'все восемь исходов в одной строке; знаменатель без big и dup',
    line,
  );
  ...
  ck(sum.includes('отправлено 3 из 10'), 'итог считает всю пачку', sum);
